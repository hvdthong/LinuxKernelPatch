...
def venn2(labels, names=['A', 'B'], **options):
    ...
    leg = ax.legend(names, loc='upper center', fancybox=True, fontsize=fontsize-4)
...
def venn3(labels, names=['A', 'B', 'C'], **options):
    ...
    leg = ax.legend(names, loc='lower left', fancybox=True, fontsize=18)
