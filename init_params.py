...
def model_parameters():
    ...
    # tf.flags.DEFINE_string("model", "bi_lstm_cnn_msg", "Running lstm model")
    # tf.flags.DEFINE_string("model", "bi_lstm_cnn_code", "Running lstm model")
...
def model_parameter_evaluation_keras():
    # Parameters
    # ==================================================
    # Data loading
    # tf.flags.DEFINE_string("path", "./data/1_oct5/eq100_line_oct5.out", "Loading path of our data")
